...
expName = 'simpleSearch'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Marcin\\Desktop\\simpleConjunction\\simpleSearch_lastrun.py',
...
image = visual.ImageStim(
    win=win,
    name='image', units='cm', 
    image='images/redHor.png', mask=None,
    ori=None, pos=(0, 0), size=(1, 1),
