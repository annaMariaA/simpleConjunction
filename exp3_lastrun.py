...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Marcin\\Documents\\GitHub\\simpleConjunction\\exp3_lastrun.py',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='Look for red horizontal bar (target).\nPress space bar as soon as you find the target.\nThe search array willl disappear when you press space bar.\nPoint with the mouse coursor the place on the screen where you think the target was.\nPress space bar to start.',
    font='Arial',
...
text_3 = visual.TextStim(win=win, name='text_3',
    ...
    languageStyle='LTR',
    depth=0.0);
feedbackTxt='You di not click on the target. Try to be more accurate.'
...
for thisTrial in trials:
    ...
    # keep track of which components have finished
    mouseClickComponents = [image_3, mouse, background]
    ...
    numClicked=len(mouse.clicked_name);
    print(numClicked)
    if numClicked == 2:
        feedbackTxt = 'Your answer was correct.'
    else:
        feedbackTxt = 'You did not click on the target. Try to be more accurate.'
    ...
    continueRoutine = True
    # update component parameters for each repeat
    text_3.setText(feedbackTxt)
    key_resp_4.keys = []
    key_resp_4.rt = []
    _key_resp_4_allKeys = []
    # keep track of which components have finished
    FeedbackComponents = [text_3, key_resp_4]
