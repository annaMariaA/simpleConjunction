...
expName = 'conSearch'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\s03an7\\Desktop\\simpleConjunction\\conSearch_lastrun.py',
...
image1 = visual.ImageStim(
    win=win,
    name='image1', units='cm', 
    image='images/redVer.jpg', mask=None,
    ori=0, pos=(5, 3), size=(3, 0.5),
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if image1.status == STARTED:
        ...
        if tThisFlipGlobal > image1.tStartRefresh + 5.0-frameTolerance:
